package code_draft_2;//package code_try_1;
import code_draft_2.models.User;
import code_draft_2.services.ExpenseService;
...
//        es.showExpense("u2");
        ...
        share = new ArrayList<>();
        share.add(100);
        es.createExpense(u3.getId(),payees,1000,share, "PERCENTAGE");
        es.showExpense(null);
